...
%--Tartalmi rész------------------------------------------
	...
	\newpage
	\include{sections/technical-conditions}
	...
	\newpage
	\include{sections/motions}
	%--Sakkalgoritmus beágyazása
	\newpage
	\include{sections/chess-algorithm}
...
\begin{abbreviations}
	\item[HRC]	\foreignlanguage{british}{Human Robot Collaboration}
	\item[IoT]	\foreignlanguage{british}{Internet of Things}
	\item[IoE]	\foreignlanguage{british}{Internet of Everything}
\end{abbreviations}
%-------------------------------------------------------
